...
echo "     gh release upload <cores-tag> \"$ZIP\" --repo Anhani1206/OpenEmuARM"
echo ""
...
echo "       https://github.com/Anhani1206/OpenEmuARM/releases/download/<cores-tag>/${CORE}.oecoreplugin.zip \\"
echo "       $BYTE_COUNT \\"
echo "       --sign-zip \"$ZIP\""
