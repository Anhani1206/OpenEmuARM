...
static static einline unsigned get_cc (unsigned flag)
{
...
static static einline void set_cc (unsigned flag, unsigned value)
{
	reg_cc &= ~flag;
	reg_cc |= value * flag;
}
...
static static einline unsigned test_c (unsigned i0, unsigned i1,
...
static static einline unsigned test_n (unsigned r)
{
	return (r >> 7) & 1;
}
...
static static einline unsigned test_z8 (unsigned r)
{
	unsigned flag;
...
static static einline unsigned test_z16 (unsigned r)
{
	unsigned flag;
...
static static einline unsigned test_v (unsigned i0, unsigned i1, unsigned r)
{
	unsigned flag;
...
static static einline unsigned get_reg_d (void)
{
	return (reg_a << 8) | (reg_b & 0xff);
}

static static einline void set_reg_d (unsigned value)
{
	reg_a = value >> 8;
	reg_b = value;
}
...
static static einline unsigned read8 (unsigned address)
{
...
static static einline void write8 (unsigned address, unsigned data)
{
	(*e6809_write8) (address & 0xffff, (unsigned char) data);
}

static static einline unsigned read16 (unsigned address)
{
...
static static einline void write16 (unsigned address, unsigned data)
{
	write8 (address, data >> 8);
	write8 (address + 1, data);
}

static static einline void push8 (unsigned *sp, unsigned data)
{
	(*sp)--;
	write8 (*sp, data);
}

static static einline unsigned pull8 (unsigned *sp)
{
	unsigned data;
...
static static einline void push16 (unsigned *sp, unsigned data)
{
	push8 (sp, data);
	push8 (sp, data >> 8);
}

static static einline unsigned pull16 (unsigned *sp)
{
	unsigned datahi, datalo;
...
static static einline unsigned pc_read8 (void)
{
	unsigned data;
...
static static einline unsigned pc_read16 (void)
{
	unsigned data;
...
static static einline unsigned sign_extend (unsigned data)
{
...
static static einline unsigned ea_direct (void)
{
...
static static einline unsigned ea_extended (void)
{
	return pc_read16 ();
}
...
static static einline unsigned ea_indexed (unsigned *cycles)
{
	unsigned r, op, ea;
